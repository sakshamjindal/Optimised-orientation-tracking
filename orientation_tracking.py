...
def run_orientation_tracking(data_path, imu_file_name):
    """
    ...
    vicon_path = os.path.join(data_path, "vicon")
...
# In[5]:
    ...
    axs[1].plot(vicon_ts, vicon_eulers[:, 1], label="Vicon", color = "blue", linestyle = "dashed")
    ...
    axs[2].plot(vicon_ts, vicon_eulers[:, 2], label="Vicon", color = "blue", linestyle = "dashed")
